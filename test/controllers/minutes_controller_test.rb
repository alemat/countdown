...
class MinutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create minute" do
    assert_difference('Minute.count') do
      post minutes_url, params: { minute: { content: @minute.content, meeting_id: @minute.meeting_id } }
    end
  ...
  test "should update minute" do
    patch minute_url(@minute), params: { minute: { content: @minute.content, meeting_id: @minute.meeting_id } }
