...
class WeeklyPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weekly_plan" do
    assert_difference('WeeklyPlan.count') do
      post weekly_plans_url, params: { weekly_plan: { plan_title: @weekly_plan.plan_title, user_id: @weekly_plan.user_id } }
    end
  ...
  test "should update weekly_plan" do
    patch weekly_plan_url(@weekly_plan), params: { weekly_plan: { plan_title: @weekly_plan.plan_title, user_id: @weekly_plan.user_id } }
